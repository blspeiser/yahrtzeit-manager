...
//               //   '${AppLocalizations.of(context)!.translate('English Name')}: ${yahrtzeitDate.yahrtzeit.englishName}\n'
//               //   '${AppLocalizations.of(context)!.translate('Hebrew Name')}: ${yahrtzeitDate.yahrtzeit.hebrewName}\n'
//               //   '${AppLocalizations.of(context)!.translate('Gregorian Date')}: ${gregorianFormatter.format(yahrtzeitDate.gregorianDate)}\n'
//               //   '${AppLocalizations.of(context)!.translate('Hebrew Date')}: ${hebrewFormatter.format(yahrtzeitDate.hebrewDate)}',
//               // );
//             },
//           ),
//         ],
